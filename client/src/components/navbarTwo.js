...
const NavbarTwo = () => {
  return (
    <nav className='w-full'>
        ...
        <ul className='overflow-x-auto w-full flex flex-row justify-between bg-yellow-300 text-gray-950 rounded-b-lg py-2 text-xs space-x-8 px-6'>
          <li className="flex-shrink-0 bg-yellow-300 w-1/7 rounded-md text-center shadow-black hover:shadow-lg h-16 items-baseline align-middle overflow-hidden px-6 pb-3">
