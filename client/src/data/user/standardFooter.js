...
const portfolio = 'https://portfolio-arpit.netlify.app'
const Footer = () => {
  return (
    <div className='bg-black footer w-full text-center flex flex-col justify-center h-40 relative z-40 items-center'>
      <div className="">
